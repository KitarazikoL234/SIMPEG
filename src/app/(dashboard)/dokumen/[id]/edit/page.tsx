      ...
      .then(json => {
        if (json.success && json.data) {
          ...
          setFormData({
            ...
            kategoriUtama: doc.kategoriUtama as KategoriUtama || '',
            subKategori: doc.subKategori || '',
            tanggalTerbit: doc.tanggalTerbit ? doc.tanggalTerbit.split('T')[0] : '',
            hasMasaBerlaku: !!doc.masaBerlaku,
            masaBerlaku: doc.masaBerlaku ? doc.masaBerlaku.split('T')[0] : '',
